...
def display_palette(colors, save_path):
    ...
    for i, color in enumerate(colors):
        row = i // 4
        col = i % 4
        ax.add_patch(plt.Rectangle((col/4, 1-row/2-0.5), 0.25, 0.5,
                                   fc=color/255, ec='none'))
...
def gen_palette(image_name, image_path):
    ...
    # save_path = "/static/palettes/" + image_name + "_palette.png"
    save_path = "./static/palettes/pallete.png"
